...
var Modal = {
  ...
  submitSuccess: function(form, result) {
    ...
    if (obj !== null && obj !== undefined) {
      ...
      $('#myModal').modal('hide');
      // FIXME: Perhaps we could be more flexible here, e.g. avoid tr rules and allow anything with
      //  correct class to update based on modal (e.g. kanban)
...
function cleanupSelectVariables() {
  $('#myModal').on('hidden.bs.modal', function () {
    inActionModal = false
    inModal = false
  })
